...
[![Go Report Card](https://goreportcard.com/badge/github.com/MPCherry/bbolt?style=flat-square)](https://goreportcard.com/report/github.com/MPCherry/bbolt)
[![Go Reference](https://pkg.go.dev/badge/github.com/MPCherry/bbolt.svg)](https://pkg.go.dev/github.com/MPCherry/bbolt)
...
```sh
$ go get github.com/MPCherry/bbolt@latest
```
...
```sh
$ go run github.com/MPCherry/bbolt/cmd/bbolt@latest
```
...
```sh
$ go install github.com/MPCherry/bbolt/cmd/bbolt@latest
```
...
```go
import bolt "github.com/MPCherry/bbolt"
...
system's page cache. See the [`Tx`](https://godoc.org/github.com/MPCherry/bbolt#Tx)
